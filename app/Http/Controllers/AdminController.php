...
public function deleteAdmin(User $user){
    ...
    return redirect(route('admin.dashboard'))->with('message','Hai correttamente rifiutato la richiesta dell\'utente scelto');
}
...
public function deleteWriter(User $user){
    ...
    public function storeCategory(Request $request){
       Category::create([
        ...
        return redirect(route('admin.dashboard'))->with('message','Hai correttamente aggiunto la categoria');
    }
}
