<div class="container-fluid me-0 mb-5">
                        ...
                        <div class="indexCard">
                            ...
                            <div class="content">
                                ...
                                <div class="card-footer">
                                    ...
                                    @if($article->category)
                                    <a href="{{route('article.byCategory',['category'=>$article->category->id])}}" class="small text-decoration-none fst-capitalize">{{$article->category->name}}</a>
                                    @else
